...
class AddPermissionsSistemaDeCamaras extends Migration
{
    ...
    public function up()
    {
        DB::table('roles')->insert([
            [ 'id' => '20', 'guard_name'  =>  'web' , 'name'  =>  'Redactor de examen', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s") ],
    ...
    /**
     * Reverse the migrations.hola@latorregabriel.com
     *
     * @return void
     */
    public function down()
    {
        ...
        DB::table('roles')->whereIn('name', ['Redactor de examen','Inspector'])->delete();
    }
}
