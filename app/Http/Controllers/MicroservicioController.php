...
class MicroservicioController extends Controller
{
    ...
    public function run(){
      ...
      $tramitesAIniciar->revisarValidaciones($this->estados->VALIDACIONES_COMPLETAS);
    ...
    function cargarEstados(){
      ...
      $this->estados->VALIDACIONES_COMPLETAS = SysMultivalue::where('text_id', 'VALIDACIONES_COMPLETAS')->where('type', 'AUTO')->first()->id;
