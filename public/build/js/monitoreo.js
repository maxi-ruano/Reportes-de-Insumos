...
function gethtmlComputadora(computadora){
  ...
  return '<div class="col-md-55">'+
      '<div class="thumbnail '+estadoComputadora+'" style = "height: auto;">'+
        '<div class="row">'+
          '<div class="col-md-6">'+
              '<img  class="img-pregunta img-responsive" onerror="this.src=\'http://192.168.76.33/teorico/public/production/images/user.png\'"  style = "height: 100%; width: 100%;" src="'+computadora.pathFoto+'" alt="Generic placeholder thumbnail">'+
          '</div>'+
